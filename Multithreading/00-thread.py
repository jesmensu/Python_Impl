...
def task():
    ...
    sleep(1)
    # display a message
    print('This is coming from new thread')
...
thread.start()
# display a message
print('This is main thread and Waiting for the new thread to finish...')
# wait for the task to complete
thread.join()
print('This is main thread and exited after the new thread completed')